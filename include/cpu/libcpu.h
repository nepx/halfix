...
// Register a handler that will provide the CPU MMU handler with pages of RAM. Every time a new page is read/written from, this callback will be issued. 
// This will not affect the speed of regular memory accesses due to the way TLB accesses are implemented. 
// Use this handler if you are planning to allocate a lot of memory but don't want to allocate all at once. 
